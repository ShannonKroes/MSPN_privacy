...
def get_splitting_functions(cols, rows, ohe, threshold, rand_gen, n_jobs, col_test="rdc"):
    ...
    from spn.algorithms.splitting.RDC import get_split_cols_RDC_py, get_split_rows_RDC_py, get_split_rows_RDC_plus_kmeans, get_split_rows_RDC_plus, get_split_rows_univ_weights, get_split_rows_univ
...
def learn_mspn(
    ...
    def l_mspn(data, ds_context, cols, rows, min_instances_slice, threshold, ohe, hist_source, total_n):
        split_cols, split_rows = get_splitting_functions(cols, rows, ohe, threshold, rand_gen, cpus, col_test)
