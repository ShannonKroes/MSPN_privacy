...
os.chdir(r"C:\Users\Shannon\Documents\Sanquin\Project 4\final files\source")
...
# so lets do 10 for both, but this is really not many , the results are also good for 150
m4=10
